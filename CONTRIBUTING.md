...
As a contributor, we present you the guidelines to start contributing in any of the Uhuru Mobile projects.
...
If you require general support assistance, you can find us in [Telegram](https://t.me/uhurumobile), and we'll help you as soon as possible.

You can chat with us via IRC in [#uhuru-mobile on freenode](http://webchat.freenode.net/?channels=uhuru-mobile).
...
Before submitting the issue please check the [issue tracker](https://github.com/uhuru-mobile/mobile-dashboard/issues), there exists the possibility that the bug was already reported by other contributor.
...
You can file new issues by filling out our [new issue form](https://github.com/uhuru-mobile/mobile-dashboard/issues/new).
...
* In GitHub, send a pull request to our [Repository](https://github.com/uhuru-mobile/mobile-dashboard).
